...
output publicIpId string = newPublicIp ? pip.id : ''

output backendPoolId string = resourceId(
  'Microsoft.Network/applicationGateways/backendAddressPools',
  name,      // use the parameter value (same as appGateway resource name)
  'default'  // matches the backend pool defined above
)
